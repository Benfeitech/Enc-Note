...
async function validateCloudinaryImage(
  ...
  if (
    ...
    throw new Error(
      "Image is not stored as a private asset"
    );
  }
  ...
  if (
    ...
    try {
      ...
      console.error(
        "Oversized image cleanup failed:",
        cleanupError
      );
    }
...
export default async function handler(
  ...
  try {
    ...
    const link =
      `${cleanBase}/read.html?slug=${encodeURIComponent(
        slug
      )}`;
